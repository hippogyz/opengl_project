...
int main()
{
    ...
    //use Shader class
    Shader shaderProg;
    shaderProg.initializeShaderVF("Code/shader/vertex_shader.vs", "Code/shader/frag_shader.fs");

    Shader refShaderProg;
    refShaderProg.initializeShaderVF("Code/shader/vertex_shader.vs", "Code/shader/ref_frag_shader.fs");

    // load texture
    // --------------
    //unsigned int texture = loadTextureFromPath(shaderProg, 0, "Resource/test_texture.jpg");
    const char* texture_path[] = {
        "Resource/test_texture.jpg",
        "Resource/test_texture2.jpg",
        "Resource/test_texture3.jpg"
    };
